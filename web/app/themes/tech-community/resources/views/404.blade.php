...
@section('content')
	<section class="pb5 bg-white baskerville">
		...
		<ul class="list tc pl0 w-100 mt5">
			...
			<li class="dib"><a class="f5 f4-ns link black db pv2 ph3 hover-light-purple" href="/events">Events</a></li>
			<li class="dib"><a class="f5 f4-ns link black db pv2 ph3 hover-light-purple" href="/contact">Contact</a></li>
			<li class="dib"><a class="f5 f4-ns link black db pv2 ph3 hover-light-purple" href="/join">Join the Community</a></li>
		</ul>
	</section>
@endsection
